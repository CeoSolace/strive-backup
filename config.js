module.exports = {
  ...
  INTERACTIONS: {
    ...
    TEST_GUILD_ID: "1383169418288173208", // Guild ID where the interactions should be registered. [** Test you commands here first **]
  },
  EMBED_COLORS: {
    BOT_EMBED: "#068ADD",
    TRANSPARENT: "#36393F",
...
DASHBOARD: {
    ...
    port: 8081,                             // The REAL dashboard port (numeric)
},
