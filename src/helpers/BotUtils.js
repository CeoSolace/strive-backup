...
module.exports = class BotUtils {
  ...
  static async checkForUpdates() {
    const response = await getJson("https://api.github.com/repos/ceosolace/Strive/releases/latest");
    ...
    if (response.data) {
      if (
        ...
        warn("download: https://github.com/ceosolace/Strive/releases/latest");
      }
    }
  }
