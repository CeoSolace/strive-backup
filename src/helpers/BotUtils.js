...
module.exports = class BotUtils {
  ...
  static async checkForUpdates() {
    const response = await getJson("https://api.github.com/repos/ceosolace/strive-backup/releases/latest");
    ...
    if (response.data) {
      if (
        ...
        warn("download: https://github.com/ceosolace/strive-backup/releases/latest");
      }
    }
  }
